...
SETUP_ITEMS = [
    "version='{0}'",
    'https://github.com/openscilab/rokh/tarball/v{0}']
README_ITEMS = [
    "[Version {0}](https://github.com/openscilab/rokh/archive/v{0}.zip)",
    "pip install rokh=={0}"]
CHANGELOG_ITEMS = [
    "## [{0}]",
    "https://github.com/openscilab/rokh/compare/v{0}...dev",
    "[{0}]:"]
PARAMS_ITEMS = ['ROKH_VERSION = "{0}"']
META_ITEMS = ['% set version = "{0}" %']
ISSUE_TEMPLATE_ITEMS = ["- Rokh {0}"]
...
FILES = {
    ...
    os.path.join("rokh", "params.py"): PARAMS_ITEMS,
    ...
    for file_name in FILES:
        try:
            ...
            for test_item in FILES[file_name]:
                if file_content.find(test_item.format(ROKH_VERSION)) == -1:
