...
EVENTS = {
    ...
    "1": {'1': [{'description': 'جشن نوروز/جشن سال نو', 'is_holiday': True}],
          '2': [{'description': 'عیدنوروز', 'is_holiday': True}],
          '3': [{'description': 'عیدنوروز', 'is_holiday': True}],
          '4': [{'description': 'عیدنوروز', 'is_holiday': True}, {'description': 'درگذشت اسماعیل ادیب خوانساری موسیقیدان ایرانی', 'is_holiday': False}],
          '6': [{'description': 'روز امید، روز شادباش نویسی', 'is_holiday': False}, {'description': 'زادروز آشو زرتشت، اَبَراِنسان بزرگ تاریخ', 'is_holiday': False}],
          '10': [{'description': 'جشن آبانگاه', 'is_holiday': False}],
          '12': [{'description': 'روز جمهوری اسلامی', 'is_holiday': True}],
          '13': [{'description': 'جشن سیزده به در', 'is_holiday': True}, {'description': 'درگذشت علی\u200cاکبر صنعتی نقاش و مجسمه\u200cساز ایرانی', 'is_holiday': False}],
    ...
    "2": {'1': [{'description': 'روز بزرگداشت سعدی', 'is_holiday': False}, {'description': 'درگذشت سهراب سپهری شاعر و نقاش ایرانی', 'is_holiday': False}],
          ...
          '3': [{'description': 'روزبزرگداشت شیخ بهایی؛ روزملی کارآفرینی؛ روز معماری', 'is_holiday': False}],
          ...
          '9': [{'description': 'روز ملی روانشناس و مشاور', 'is_holiday': False}, {'description': 'درگذشت ذبیح\u200cالله صفا، پژوهشگر، مترجم و استاد ممتاز دانشگاه تهران', 'is_holiday': False}],
          ...
          '12': [{'description': 'روز معلم', 'is_holiday': False}, {'description': 'درگذشت محمدرضا لطفی، نوازندهٔ برجسته و سرشناس تار، سه\u200cتار و ردیف\u200cدان، موسیقی\u200cدان و آهنگساز', 'is_holiday': False}],
          '14': [{'description': 'زادروزخواجه عبدالله انصاری، ادیب، عارف و اندیشمند ایرانی', 'is_holiday': False}],
          '15': [{'description': 'جشن میانه بهار/جشن بهاربد؛ روز شیراز', 'is_holiday': False}, {'description': 'زادروز غلامحسین بنان، خوانندهٔ ایرانی', 'is_holiday': False}],
          ...
          '22': [{'description': 'زادروز مریم میرزاخانی ریاضیدان ایرانی، اولین زن برندهٔ جایزه فیلدز', 'is_holiday': False}, {'description': 'روز جهانی زن در ریاضیات (به افتخار روز تولد مریم میرزاخانی)', 'is_holiday': False}],
    ...
    "3": {'1': [{'description': 'روز بهره وری و بهینه سازی مصرف', 'is_holiday': False}, {'description': 'روز بزرگداشت ملاصدرا', 'is_holiday': False}, {'description': 'زادروز جلیل شهناز، از سرشناس\u200cترین نوازندگان تار و سه تار سدهٔ اخیر در ایران', 'is_holiday': False}],
          ...
          '15': [{'description': 'قیام 15 خرداد', 'is_holiday': True}, {'description': 'درگذشت شیخ بهایی دانشمند عصر صفوی', 'is_holiday': False}],
    ...
    "4": {'1': [{'description': 'جشن آب پاشونک، جشن آغاز تابستان', 'is_holiday': False}, {'description': 'درگذشت ابن سینا فیلسوف، پزشک و دانشمند نامدار ایرانی', 'is_holiday': False}, {'description': 'درگذشت غیاث\u200cالدین جمشید کاشانی ریاضیدان و اخترشناس ایرانی', 'is_holiday': False}],
          ...
          '10': [{'description': 'روز صنعت و معدن', 'is_holiday': False}, {'description': 'زادروز بابک خرمدین، سپه\u200cسالار دلاور ایران', 'is_holiday': False}, {'description': 'روز بزرگداشت صائب تبریزی', 'is_holiday': False}],
          ...
          '13': [{'description': 'تیر روز،جشن تیرگان', 'is_holiday': False}, {'description': 'زادروز فرشید مثقالی مجسمه\u200cساز، گرافیست و تصویرگر کتاب کودک، اولین و تنها ایرانی برنده جایزه هانس کریستیان آندرسن', 'is_holiday': False}, {'description': 'جشن تیرگان، بزرگداشت کمان کشیدن جان فدای ایران، آرش کمانگیر بر فراز البرز', 'is_holiday': False}],
          ...
          '22': [{'description': 'زادروز عباس زریاب خویی، مترجم، تاریخ\u200cدان و کتاب\u200cشناس ایرانی', 'is_holiday': False}, {'description': 'درگذشت مهدی حمیدی شیرازی، ادیب، شاعر، مترجم و منتقد ایرانی', 'is_holiday': False}, {'description': 'زادروز محمد خوارزمی، ریاضیدان و فیلسوف ایرانی و روز ملی فناوری اطلاعات', 'is_holiday': False}],
    ...
    "6": {'1': [{'description': 'روز بزرگداشت ابوعلی سینا و روز پزشک', 'is_holiday': False}],
          ...
          '4': [{'description': 'زادروز داراب (کوروش)', 'is_holiday': False}, {'description': 'شهریور روز،جشن شهریورگان', 'is_holiday': False}, {'description': 'زادروز کوروش بزرگ', 'is_holiday': False}],
          '5': [{'description': 'روز بزرگداشت محمدبن زکریای رازی و روز داروساز', 'is_holiday': False}],
          '8': [{'description': 'انفجار در دفتر نخست\u200cوزیری جمهوری اسلامی ایران، روز مبارزه با تروریسم', 'is_holiday': False}, {'description': 'درگذشت علامه حلی از علمای شیعه قرن هشتم قمری', 'is_holiday': False}],
          '10': [{'description': 'امضای معاهده تقسیم ایران بین روسیه و انگلیس', 'is_holiday': False}],
          '11': [{'description': 'روزصنعت چاپ', 'is_holiday': False}, {'description': 'وقوع زلزله بویین زهرا و مرگ بیش از 25 هزار نفر', 'is_holiday': False}, {'description': 'درگذشت محمود حسابی فیزیکدان، سناتور، وزیر آموزش و پرورش و بنیانگذار دانشگاهی در ایران', 'is_holiday': False}],
          ...
          '17': [{'description': 'قیام 17 شهریور', 'is_holiday': False}, {'description': 'درگذشت جلال آل احمد روشنفکر دینی، نویسنده و مترجم ایرانی و همسر سیمین دانشور', 'is_holiday': False}],
          ...
          '23': [{'description': 'سفر انوشه انصاری به\u200cعنوان اولین زن گردشگر فضایی به دور مدار زمین', 'is_holiday': False}, {'description': 'درگذشت هانیبال الخاص، نقاش و مجسمه ساز ایرانی', 'is_holiday': False}],
          '24': [{'description': 'اعدام صادق قطب\u200cزاده، وزیر سابق امور خارجه جمهوری اسلامی ایران', 'is_holiday': False}, {'description': 'درگذشت عبدالحسین زرین\u200cکوب خوانساری، ادیب، تاریخ\u200cنگار و منتقد ادبی برجسته ایران', 'is_holiday': False}],
          '25': [{'description': 'زمین لرزه طبس به قدرت 7/8 ریشتر', 'is_holiday': False}, {'description': 'برگزاری انتخابات دوره نخست مجلس شورای ملی', 'is_holiday': False}],
    ...
    "8": {'1': [{'description': 'روز آمار و برنامه ریزی', 'is_holiday': False}, {'description': 'آغاز کار نخستین فرستنده تلویزیون دولتی ایران، به نام «شبکه ملی»', 'is_holiday': False},{'description': 'روز بزرگداشت ابوالفضل بیهقی، تاریخ\u200cنگار و نویسنده ایرانی', 'is_holiday': False}],
          ...
          '8': [{'description': 'روز نوجوان', 'is_holiday': False}, {'description': 'زادروز آیدین آغداشلو نقاش، نویسنده، منتقد فیلم و طراح هنرمند ایرانی', 'is_holiday': False}],
          ...
          '21': [{'description': 'زادروز نیما یوشیج پدر شعر نو پارسی', 'is_holiday': False}, {'description': 'درگذشت هاراطون داویدیان بنیانگذار روانپزشکی درایران', 'is_holiday': False}],
    ...
    "9": {'1': [{'description': 'آذر جشن', 'is_holiday': False}],
          ...
          '16': [{'description': 'روز دانشجو', 'is_holiday': False}, {'description': 'کناره گیری رضا شاه از سلطنت به نفع پسرش محمدرضا پهلوی در پی اشغال ایران در جنگ جهانی دوم توسط نیروهای متفقین', 'is_holiday': False}],
          ...
          '21': [{'description': 'زادروز احمد شاملو شاعر و نویسنده و مترجم ایرانی', 'is_holiday': False}, {'description': 'سالروز نجات آذربایجان', 'is_holiday': False}],
    ...
    "10": {'1': [{'description': 'روز میلاد خورشید؛ جشن خرم روز، نخستین جشن دیگان', 'is_holiday': False}],
           ...
           '13': [{'description': 'درگذشت نیما یوشیج پدر شعر نو پارسی', 'is_holiday': False}, {'description': 'شهادت سردار حاج قاسم سلیمانی [1398 خورشیدی]', 'is_holiday': False}],
           '15': [{'description': 'دی به مهر روز، سومین جشن دیگان', 'is_holiday': False}, {'description': 'شهادت منصور ستاری از فرماندهان نیروی هوایی ارتش جمهوری اسلامی ایران', 'is_holiday': False}],
           '16': [{'description': 'غرق شدن کشتی سانچی [1396 خورشیدی]', 'is_holiday': False}],
           '17': [{'description': 'اعدام بابک خرمدین به دست معتصم، خلیفه عباسی در سامرا', 'is_holiday': False}, {'description': 'حادثه کشته شدن 56 تن از تشیع کنندگان در کرمان', 'is_holiday': False}],
