...
EVENTS = {
    ...
    "1": {'1': [{'description': 'جشن نوروز/جشن سال نو', 'is_holiday': True}],
          ...
          '4': [{'description': 'عید نوروز', 'is_holiday': True}, {'description': 'درگذشت اسماعیل ادیب خوانساری موسیقیدان ایرانی', 'is_holiday': False}],
    ...
    "4": {'1': [{'description': 'جشن آب پاشونک، جشن آغاز تابستان', 'is_holiday': False}, {'description': 'درگذشت ابن سینا فیلسوف، پزشک و دانشمند نامدار ایرانی', 'is_holiday': False}, {'description': 'درگذشت غیاث‌الدین جمشید کاشانی ریاضیدان و اخترشناس ایرانی', 'is_holiday': False}],
          ...
          '13': [{'description': 'تیر روز، جشن تیرگان', 'is_holiday': False},
                 {'description': 'زادروز فرشید مثقالی مجسمه‌ساز، گرافیست و تصویرگر کتاب کودک، اولین و تنها ایرانی برنده جایزه هانس کریستیان آندرسن', 'is_holiday': False}, {'description': 'جشن تیرگان، بزرگداشت کمان کشیدن جان فدای ایران، آرش کمانگیر بر فراز البرز', 'is_holiday': False}],
